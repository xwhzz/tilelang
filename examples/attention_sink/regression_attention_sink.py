...
def regression_example_mha_sink_fwd_bhsd_sliding_window():
    tilelang.testing.process_func(
        example_mha_sink_fwd_bhsd.run_regression_perf, window_size=128
    )
...
def regression_example_mha_sink_fwd_bhsd_wgmma_pipelined_sliding_window():
    tilelang.testing.process_func(
        example_mha_sink_fwd_bhsd_wgmma_pipelined.run_regression_perf, window_size=128
    )
...
def regression_example_gqa_sink_fwd_bhsd_wgmma_pipelined_sliding_window():
    tilelang.testing.process_func(
        example_gqa_sink_fwd_bhsd_wgmma_pipelined.run_regression_perf, window_size=128
    )
...
def regression_example_mha_sink_bwd_bhsd_sliding_window():
    tilelang.testing.process_func(
        example_mha_sink_bwd_bhsd.run_regression_perf, window_size=128
    )
...
def regression_example_gqa_sink_bwd_bhsd_sliding_window():
    tilelang.testing.process_func(
        example_gqa_sink_bwd_bhsd.run_regression_perf, window_size=128
    )
