...
class WorkUnit:
    def __init__(self, name, coord, data_size_lines):
        self.name = name
        self.coord = coord
        self.size = data_size_lines
...
def analyze_l2_hit_rate(sequence: list[WorkUnit], l2_cap_bytes: int, l2_assoc=16, cache_line_size=128, sm_count=114):
