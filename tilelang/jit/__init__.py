...
# Import backend module to trigger torch.compile backend registration.
import tilelang.jit.backend as _backend  # noqa: F401
...
def compile(
    ...
    """
    Compile a TileLang PrimFunc into a JITKernel.

    For graph-mode compilation of PyTorch functions, use
    ``torch.compile(fn, backend="tilelang")`` instead.
